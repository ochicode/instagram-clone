    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="d-flex align-items-center mb-3">
                @if($post->user)
                <img src="{{ $post->user->profile_image ? Storage::disk('s3')->temporaryUrl($post->user->profile_image, now()->addHour()) : 'https://avatar.iran.liara.run/public' }}"
                ...
                @endif
                @else
                <img src="https://avatar.iran.liara.run/public" class="rounded-circle me-3"
